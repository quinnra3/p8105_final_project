...
We hypothesize that trash pickup in NYC is a predictor of rodent sightings in NYC. To test this hypothesis, we are going to use three different models to predict rodent sightings based on trash pickup in NYC, by longitude and latitude:
