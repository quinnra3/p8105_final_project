...
This graph illustrates a proposed relationship between trash tonnage and rat sightings. Our group hypothesized that where there is more trash collected, there will be a higher rat presence. 
...
rat_app_one_plot = 
  ...
  facet_grid(. ~ borough) + 
  theme(axis.text.x = element_text(angle = 65, hjust = 4))
...
These graphs illustrate how many rat sightings were recorded in various subway stations in each borough. In this case, Manhattan has the most rat sightings compared to the other boroughs and Staten Island still has the least. 
